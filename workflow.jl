...
stack = RasterStack("grid_conc_20140811000000_nest_CH4.nc")
...
begin
	labels = [getcomment(stack, ind)[1:10] for ind in relvertcut]
	cuts = [conc[ 
		X(Near(loclon)),
		Y(Near(loclat)),
		Ti(At(datetoplot)),
...
getcomment(stack, reltoplot::Int)
...
relstartsecs = stack[:RELSTART] |> collect
...
relmass = stack[:RELXMASS][:, 1] |> collect
...
git-tree-sha1 = "7a965b3c76b33737a7231ed0abaee596b5e4c57f"
